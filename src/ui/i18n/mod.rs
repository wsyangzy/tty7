...
l10n_keys! {
    ...
    SettingsSidebarGitDisplay,
    SettingsSidebarGitDisplayDesc,
    SettingsSidebarGitFull,
    SettingsSidebarGitCounts,
    SettingsSidebarGitHidden,
    ...
    SettingsAgentNotifications,
    SettingsAgentNotificationsDesc,
    SettingsNotifyThreshold,
    SettingsNotifyThresholdDesc,
    NotifyModeNever,
    NotifyModeUnfocused,
    AgentNotifyModeUnfocused,
    NotifyModeAlways,
    ...
    SettingsSearchAgentNotificationsKeywords,
